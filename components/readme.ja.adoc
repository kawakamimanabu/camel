...
コンポーネントの数: 294 in 230 JAR artifacts (0 deprecated)
...
| link:camel-jdbc/src/main/docs/jdbc-component.ja.adoc[JDBC] (camel-jdbc) +
`jdbc:dataSourceName` | 1.2 | jdbc コンポーネントは JDBC 経由でデータベースにアクセスでき、SQL のクエリはメッセージボディで送信される。
...
データフォーマットの数: 45 in 35 JAR artifacts (0 deprecated)
...
| link:camel-jacksonxml/src/main/docs/jacksonxml-dataformat.ja.adoc[JacksonXML] (camel-jacksonxml) | 2.16 | JacksonXML データフォーマットは XML ペイロードをアンマーシャリングしたり、POJO を XML ペイロードにマーシャリングしたりするのに使われる。
...
| link:camel-jackson/src/main/docs/json-jackson-dataformat.ja.adoc[JSon Jackson] (camel-jackson) | 2.0 | JSon データフォーマットは JSon ペイロードをアンマーシャリングしたり、POJO を JSon ペイロードにマーシャリングしたりするのに使われる。
...
言語の数: 18 in 9 JAR artifacts (1 deprecated)
...
その他のコンポーネントの数: 30 in 30 JAR artifacts (0 deprecated)
